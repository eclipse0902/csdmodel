...
cd /home/mjkang/cbramod/csdmodel/visualize/

python reconstruct.py \
    --model_path /remotenas0/database/TUH_Corpus/tuh_eeg_abnormal/v3.0.1/edf/best_pretrain_model.pth \
    --data_path /remotenas0/database/TUH_Corpus/tuh_eeg_abnormal/v3.0.1/edf/normalized_fq/val \
    --output_dir ./results \
    --num_samples 3
...
def run_interactive_demo():
    ...
    # Mock µ¥ÀÌÅÍ
    original = torch.randn(15, 19, 19, 2) * 0.3
