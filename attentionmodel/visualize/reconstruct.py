...
def load_test_data(dataset_path: str, num_samples: int = 3):
    """? °³¼±µÈ Å×½ºÆ® µ¥ÀÌÅÍ ·Îµù"""
...
def main():
    ...
    possible_model_paths = [
        ...
        "/home/mjkang/cbramod/attentionmodel/checkpoints/best_pretrain_model.pth"
    ]
    ...
    possible_dataset_paths = [
        "/remotenas0/database/TUH_Corpus/tuh_eeg_abnormal/v3.0.1/edf/normalized_20freq/test",
        "./data/test",
        "./test_data"
    ]
    ...
    output_dir = "./eeg_visualizations_new"
