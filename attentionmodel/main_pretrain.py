...
c
python /home/mjkang/cbramod/attentionmodel/main_pretrain.py --mode pretrain \
...
def pretrain_mode(args):
    ...
    print(f"   Best model: /home/mjkang/cbramod/20newmodel/checkpoints/best_pretrain_model.pth")
